...
;Luffa-256 hash function
.global luffa256
.func luffa256  ;r25,r24 : pointer of data
...
; r29:28 : output address
.func XOR256_step
XOR256BLOCK:
	ldi	r27,hi8(chain1)	; X:chain1
	ldi	r26,lo8(chain1)
	ldi	r31,hi8(chain2)	; Z:chain2
	ldi	r30,lo8(chain2)
	ldi	r16,32
loopXOR256BLOCK:
	ld	r0,X+
...
;Luffa-256 Step Function
.func luffa256_step
luffa256_step:
	; Tweaks
	ldi	r29,hi8(chain3+32)	; Y:chain3+32
	ldi	r28,lo8(chain3+32)
	rcall ROTL1		
