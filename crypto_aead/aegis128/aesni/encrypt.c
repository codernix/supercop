...
static void aegis128_tag_generation(unsigned long long msglen, unsigned long long adlen, unsigned char maclen, unsigned char *mac, __m128i *state)
{
       int i;
        ...
        _mm_storeu_si128((__m128i*)t, state[4]);
	...
	)
{
        ...
        *mlen = clen - 16; 
        ...
        if (  (*mlen & 0xf) != 0 )  {
              ...
              aegis128_state[0] = _mm_xor_si128( aegis128_state[0], _mm_loadu_si128((__m128i*)plaintextblock)  ) ;
        }     
